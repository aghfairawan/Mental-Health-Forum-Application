  ...
  return (
    <FlowFooter container className="bg-dark-navy dark:bg-dark-navy text-white ">
      <div className="w-full text-center">
        <div className="max-w-7xl mx-auto justify-between sm:flex sm:items-start sm:justify-between -mt-2">
          <div className="">
            <FlowFooter.Title className="text-white flex items-center md:items-start justify-center md:justify-normal text-lg" title="Health Haven Forum" />
            <FlowFooter.LinkGroup col className="text-white flex items-center md:items-start mb-2 md:mb-0 -mt-3">
          ...
          <div className="">
            <FlowFooter.Title className="text-white flex justify-center md:justify-normal items-start md:items-start" title="Useful Info" />
            <FlowFooter.LinkGroup col className="text-white flex items-center md:items-start mb-2 md:mb-0 -mt-3">
          ...
          <div className="">
            <FlowFooter.Title className="text-white flex items-center md:items-start justify-center md:justify-normal" title="Contact Us" />
